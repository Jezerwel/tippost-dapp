...
export interface TipPostInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "LIKEMINIMUM_COST",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_CAPTION_LENGTH",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getTotalEarned",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface TipPost extends BaseContract {
  ...
  LIKEMINIMUM_COST: TypedContractMethod<[], [bigint], "view">;

  MAX_CAPTION_LENGTH: TypedContractMethod<[], [bigint], "view">;

  checkLiked: TypedContractMethod<
    [_postId: BigNumberish, _user: AddressLike],
    [boolean],
    "view"
  >;
  ...
  getPost: TypedContractMethod<
    ...
    [TipPost.PostStructOutput],
    "view"
  >;

  getTotalEarned: TypedContractMethod<[_user: AddressLike], [bigint], "view">;
  ...
  likePost: TypedContractMethod<[_postId: BigNumberish], [void], "payable">;
  ...
  getFunction(
    nameOrSignature: "LIKEMINIMUM_COST"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "MAX_CAPTION_LENGTH"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "getTotalEarned"
